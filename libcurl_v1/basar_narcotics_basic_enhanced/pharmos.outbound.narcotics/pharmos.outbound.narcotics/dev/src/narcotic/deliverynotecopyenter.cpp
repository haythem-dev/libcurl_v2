...
//-------------------------------------------------------------------------------------------------//
DeliverynoteCopyEnter::DeliverynoteCopyEnter( ContributionVoucherVC *parent )
:QObject( parent ), m_dialog( *parent )
{
}

//-------------------------------------------------------------------------------------------------//
DeliverynoteCopyEnter::~DeliverynoteCopyEnter(void)
{
}

//-------------------------------------------------------------------------------------------------//
bool DeliverynoteCopyEnter::eventFilter( QObject *obj, QEvent *event )
{
	bool result = false;
...
//-------------------------------------------------------------------------------------------------//
bool DeliverynoteCopyEnter::keyPressEvent( QObject *obj, QKeyEvent *keyEvent )
{
	bool result = false;
	obj;
